...
function createResponsiveClassName (...parameters: [ResponsiveClassName<number | string> | undefined, string, string][]): string | undefined {
  ...
  if (createdResponsiveClassName.length > 0) {
